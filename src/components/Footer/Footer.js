    ...
    <footer className="footer">
      <div  style={{ height: '100%', overflow: 'hidden'}}>
        <div className="footer-content">
          <button className="tbutton" style={{backgroundColor: "#fdd835"}} >
            <svg
              ...
              height="36px"
            >
              <rect width="36" height="36" x="0" y="0" fill="#fdd83500"></rect>
              <path
                fill="#e53935"
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "0 20px"}}>
            <div className="footer-socials">
              ...
              <button className="tbtn" >
              <div><FaLocationDot className="social-icon"/></div>
              </button>
              <button className="tbtn" >
