  ...
  return (
    <>
      ...
      <div className="schedule-container md:mt-0 mt-16 sm:h-lvh h-full overflow-scroll ">
        ...
        <div className="schedule-content flex sm:flex-row flex-col sm:overflow-hidden overflow-scroll ">
      ...
      <div className="mega-events">
        <div className="mega-night-section text-center mt-10 ">

          <h1 className="mega-night-heading text-4xl font-Rokybilly.ttf">Mega Night</h1>
          <div className="images-container mt-5">
            ...
            <div className="side-images flex justify-center gap-5">
              <img
                src="band.png"
                alt="Side Image 1"
